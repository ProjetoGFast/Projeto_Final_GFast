...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 14-Fev-2022 às 14:08
...
CREATE TABLE IF NOT EXISTS `encomendas` (
  ...
  `enc_idguitarra` int(11) NOT NULL,
  PRIMARY KEY (`enc_id`),
  KEY `guitarra_encomenda_fk` (`enc_idguitarra`),
  KEY `user_encomenda_fk` (`enc_iduser`)
...
INSERT INTO `encomendas` (`enc_id`, `enc_nome`, `enc_morada`, `enc_estado`, `enc_iduser`, `enc_idguitarra`) VALUES
(2, 'teste', 'testerrr', 2, 8, 5),
(16, 'uuuu', 'uuuu', 2, 8, 8),
(17, 'uuuu', 'uuuu', 2, 8, 9);
...
--
-- Estrutura da tabela `encomenda_user`
--

DROP TABLE IF EXISTS `encomenda_user`;
CREATE TABLE IF NOT EXISTS `encomenda_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `enc_id` int(11) NOT NULL,
  `iduser` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_encomenda_fk` (`iduser`),
  KEY `encomenda_user_fk` (`enc_id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `encomenda_user`
--

INSERT INTO `encomenda_user` (`id`, `enc_id`, `iduser`) VALUES
(10, 17, 8);
...
ALTER TABLE `encomendas`
  ADD CONSTRAINT `guitarra_encomenda_fk` FOREIGN KEY (`enc_idguitarra`) REFERENCES `guitarras` (`gui_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `user_encomenda_fk` FOREIGN KEY (`enc_iduser`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
