...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 16-Jan-2022 às 20:08
...
CREATE TABLE IF NOT EXISTS `favoritos` (
  ...
  `fav_idsaldo` int(11) DEFAULT NULL,
  PRIMARY KEY (`fav_id`),
...
(5, 'TESTEGUITARRA', 3, 1, 'FA-135CE', 'TESTETESTE', 123, 23, 'Epiphone SG Standard \'61 Vintage Cherry.jpg', NULL, 0),
...
(6, 'cliente', '4lE9GjSjUg_rk-6MYmP0ubUmlK4pjgfx', '$2y$13$WXxm6ut.KmypW5ihunwQ1e8bcGIpRos0gXowKbuHeAsnveIJmC.w.', NULL, 'cliente@gfast.ptj', 10, 1636061825, 1642346017, 'AgN6mb6Chg-anGbk0ngsZaPsHVHRhNV6_1636061825', 'Cliente', 'GFast', 'Leiria', 910056456, 123456789, 0, 0),
(8, 'admin', '4tHXaQz54QJ7fe4MHqVPL8D9IZY6SQdg', '$2y$13$8VEAJeFOy.DnSCU05/LR2.ZY8iw3nUdKGUkU06K5tfUqx13b.KTka', NULL, 'teste@tefste.pt', 10, 1636407591, 1642348164, 'B7rJOEI9aMVIQH3zeQEkMUNiCjmqfWOp_1636407591', 'Admin', 'GFast', 'Leiria', 910000043, 123123123, 12, 0);
