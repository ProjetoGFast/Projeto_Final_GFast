                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                ...
                                <h2>A tua loja de guitarras favorita</h2>
                        ...
                        <div class="item">
                            <div class="col-sm-6">
                                <h1><span>G</span>Fast</h1>
                                <h2>Tudo o que procuras, está na GFast</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                <button type="button" class="btn btn-default get">Compra agora</button>
                            </div>
                            <div class="col-sm-6">
...
<!-- |--------------------------------------------- CARROUSEL----------------------------------------------| -->
>>>>>>> 72237dcbbb38594de2ecc0f7711b1f128ff15004
...
<<<<<<< HEAD
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="#">Baixo eletrico</a></h4>
                            </div>
                        </div>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#"> <span class="pull-right"></span>Fender</a></li>
                                <li><a href="#"> <span class="pull-right"></span>Music Man</a></li>
                                <li><a href="#"> <span class="pull-right"></span>Jackson</a></li>
                                <li><a href="#"> <span class="pull-right"></span>Ibanez</a></li>
                                <li><a href="#"> <span class="pull-right"></span>Charvel</a></li>
                                <li><a href="#"> <span class="pull-right"></span>ESP</a></li>
                                <li><a href="#"> <span class="pull-right"></span>Gibson</a></li>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Designed by <span>GFast</span></p>
            </div>
        </div>
    </div>
